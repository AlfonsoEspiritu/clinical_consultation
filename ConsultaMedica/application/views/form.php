...
<body>
    ...
    <form action="<?php echo(site_url('Home_controller/guarda_formulario')); ?>" method="POST">
        ...
        <div class="telefono_div">
            <label for="Numero de Telefono"><b>Numero de Telefono<span style="color: red;">*</span></b></label><br/>
        ...
        <div class="direccion_div">
            ...
            <input class="controls" type="text" name="cp" id="cp" placeholder="Codigo Postal">
